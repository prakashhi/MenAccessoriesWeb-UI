...
export const ProductData = [
  {
    category: "Wallets",
    products: [
      { id:1,name: "Classic Leather Wallet", img: Wallet, price: 799 },
      { id:2,name: "Slim Card Holder Wallet", img: Wallet, price: 599 },
      { id:3,name: "Premium Bifold Wallet", img: Wallet, price: 999 },
      { id:4,name: "Vintage Brown Wallet", img: Wallet, price: 899 },
      { id:5,name: "Minimalist Black Wallet", img: Wallet, price: 749 },
      { id:6,name: "Classic Leather Wallet", img: Wallet, price: 799 },
      { id:7,name: "Slim Card Holder Wallet", img: Wallet, price: 599 },
      { id:8,name: "Premium Bifold Wallet", img: Wallet, price: 999 },
      { id:9,name: "Vintage Brown Wallet", img: Wallet, price: 899 },
      { id:10,name: "Minimalist Black Wallet", img: Wallet, price: 749 },
    ],
  },
